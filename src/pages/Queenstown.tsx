...
function Queenstown() {
  ...
  return (
     < >
     <Menu />
     <Filter color="darkolivegreen" link1='/queenstown' link2='/queenstownrestaurant' link3='/queenstowntonhotels' img1='queenstownGondolas.jpg'  subtitle1="Passeios" img2="wellingtonrestaurant.jpg" subtitle2="Nest Kitchen" img3="StoneridgeEstate.jpeg" subtitle3="Hotels"/>
